        ...
        <main ref={vantaRef} className="w-screen min-h-screen flex flex-col justify-center items-center text-white">
            <div className="max-w-5xl h-full flex flex-col text-center justify-center items-center">
                <p className="text-6xl font-bold mb-4">
                    <a href="https://www.harmoniedurrant.com/">
                        Harmonie Durrant
                    </a>
                </p>
                <p className="text-2xl font-semibold mb-16">All of these links will take you to my many social media or websites/projects</p>
                <a
                ...
                <a
                    href="https://wiki42.harmoniedurrant.com"
                    className="mb-4 w-[80%] h-auto flex justify-center items-center"
                >
                    <button type="button" className="btn w-full text-white bg-gradient-to-r from-[#222222] to-[#444444] hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-purple-800">
                        Wiki42
                    </button>
                </a>
                <a
