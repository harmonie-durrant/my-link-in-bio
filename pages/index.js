    ...
    return (
        <main ref={vantaRef} className="w-screen min-h-screen flex flex-col justify-center items-center text-white">
            <div className="max-w-5xl h-full flex flex-col text-center justify-center items-center">
                ...
                >
                    <button type="button" className="flex flex-row justify-center items-center w-full py-4 text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-semibold rounded-lg text-md text-center">
                        Instagram
                    </button> 
                </a>
                <a
                    ...
                    className="mb-4 w-[80%] h-auto flex flex-col justify-center items-center"
                >
                    <button type="button" className="flex flex-row justify-center items-center w-full py-4 text-white bg-gradient-to-br from-purple-500 to-blue-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-purple-800 font-semibold rounded-lg text-md text-center">
